...
const JobSeekerRegisterEngineer: React.FC = () => {
  ...
  if (documentsData) {
    ...
    return (
      <>
        <Helmet>
          <title>{t('register.engineerRegister.passwordStep.title')} - JustJoin</title>
        </Helmet>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-2xl">
                  {t('register.engineerRegister.passwordStep.title')}
                </CardTitle>
                <CardDescription>
                  {t('register.engineerRegister.passwordStep.description')}
                </CardDescription>
              </CardHeader>
              <CardContent>
                <form onSubmit={handlePasswordSubmit} className="space-y-4">
                  <div className="space-y-2">
                    <Label htmlFor="password">
                      ...
                      {t('register.engineerRegister.password.label')}
                    </Label>
                    <div className="relative">
                      <Input
                        ...
                        placeholder={t('register.engineerRegister.password.placeholder')}
                        required
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="confirmPassword">
                      {t('register.engineerRegister.passwordConfirm.label')}
                    </Label>
                    <div className="relative">
                      <Input
                        id="confirmPassword"
                        ...
                        placeholder={t('register.engineerRegister.passwordConfirm.placeholder')}
                        required
                        disabled={isSubmitting}
                      />
                      <button
                  ...
                  <Button type="submit" className="w-full" disabled={isSubmitting || !password || !confirmPassword}>
                    {isSubmitting ? (
                      <>
                        ...
                        {t('register.engineerRegister.passwordStep.submitting')}
                      </>
                    ) : (
                      <>
                        {t('register.engineerRegister.passwordStep.submit')}
  ...
  return (
    <>
      <Helmet>
        <title>{t('register.engineerRegister.title')} - JustJoin</title>
        <meta name="description" content={t('register.engineerRegister.descriptionMeta')} />
      </Helmet>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="mb-6 flex justify-between items-center">
            ...
            >
              ...
              {t('register.engineerRegister.back')}
            </Button>
            <LanguageToggle />
          </div>
          ...
          <Card className="mb-6">
            <CardHeader>
              <CardTitle className="text-2xl">
                {t('register.engineerRegister.title')}
              </CardTitle>
              <CardDescription>
                {t('register.engineerRegister.description', { firstName, lastName })}
              </CardDescription>
            </CardHeader>
          </Card>
