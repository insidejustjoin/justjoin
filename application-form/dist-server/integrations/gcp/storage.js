 ...
 */
export const saveDocumentToGCS = async (documentData) => {
    try {
 ...
 */
export const loadDocumentFromGCS = async (userId, documentType = 'all') => {
    try {
        const bucket = storage.bucket(bucketName);
 ...
 * ユーザーの全書類データを削除
 */
export const deleteUserDocumentsFromGCS = async (userId) => {
    try {
        const bucket = storage.bucket(bucketName);
 ...
 */
export const uploadToCloudStorage = async (file, folder = 'blog-images') => {
    try {
