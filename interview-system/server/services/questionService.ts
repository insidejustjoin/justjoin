import { Question, QuestionType, Language } from '../../src/types/interview';
...
export class QuestionService {
   ...
   * 質問の進捗率を計算
   */
  getProgressPercentage(currentQuestionIndex: number): number {
   ...
   * 言語に応じた質問テキストを取得
   */
  getQuestionText(questionId: string, language: Language): string {
   ...
   * 面接が完了しているかチェック
   */
  isInterviewComplete(currentQuestionIndex: number): boolean {
