...
class VoicevoxService {
    constructor() {
        this.defaultSpeakerId = 1; // ずんだもん（デフォルト）
     ...
     */
    async synthesizeSpeech(text, speakerId = 1) {
        try {
            // 1. テキストを音声クエリに変換
     ...
     */
    async synthesizeSpeechAsBase64(text, speakerId = 1) {
...
exports.default = VoicevoxService.getInstance();
//# sourceMappingURL=voicevoxService.js.map