...
- **AI エンジン**: カスタムAI面接官サービス
- **データベース**: メインプラットフォームと共有（PostgreSQL）
- **デプロイ予定**: `interview.justjoin.jp` サブドメイン
...
3. 面接準備フロー（4ステップ確認）
   - 基本情報確認
   - 同意事項確認
   - 環境確認（マイク・カメラ・インターネット・音声・環境）
   - 最終確認
   ↓
4. AI面接官による自動面接進行（10-15分）
   ↓
5. リアルタイム回答評価・記録
   ↓
6. 面接完了・サマリー生成
...
### 質問内容
1. 簡単に自己紹介をしてください
2. 現在の職務内容について教えてください  
3. これまでに最も達成感を感じたプロジェクトについて教えてください
4. チームでの役割についてどのように考えていますか？
5. 当社（Just Join）に応募した理由は何ですか？
6. ご自身の強み・弱みを教えてください
7. 技術的に得意な分野と今後学びたい技術は何ですか？
8. 困難な問題に直面した時、どのように解決しますか？
9. 将来的なキャリアビジョンについて教えてください
10. 最後に何か質問はありますか？
